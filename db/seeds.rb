...
# States
State.delete_all
State.create(:iso=>"AR",:name=>"Arkansas",:countries_id=>233)
State.create(:iso=>"DC",:name=>"Washington, D.C.",:countries_id=>233)
State.create(:iso=>"DE",:name=>"Delaware",:countries_id=>233)
State.create(:iso=>"FL",:name=>"Florida",:countries_id=>233)
State.create(:iso=>"GA",:name=>"Georgia",:countries_id=>233)
State.create(:iso=>"KS",:name=>"Kansas",:countries_id=>233)
State.create(:iso=>"LA",:name=>"Louisiana",:countries_id=>233)
State.create(:iso=>"MD",:name=>"Maryland",:countries_id=>233)
State.create(:iso=>"MO",:name=>"Missouri",:countries_id=>233)
State.create(:iso=>"MS",:name=>"Mississippi",:countries_id=>233)
State.create(:iso=>"NC",:name=>"North Carolina",:countries_id=>233)
State.create(:iso=>"OK",:name=>"Oklahoma",:countries_id=>233)
State.create(:iso=>"SC",:name=>"South Carolina",:countries_id=>233)
State.create(:iso=>"TN",:name=>"Tennessee",:countries_id=>233)
State.create(:iso=>"TX",:name=>"Texas",:countries_id=>233)
State.create(:iso=>"WV",:name=>"West Virginia",:countries_id=>233)
State.create(:iso=>"AL",:name=>"Alabama",:countries_id=>233)
State.create(:iso=>"CT",:name=>"Connecticut",:countries_id=>233)
State.create(:iso=>"IA",:name=>"Iowa",:countries_id=>233)
State.create(:iso=>"IL",:name=>"Illinois",:countries_id=>233)
State.create(:iso=>"IN",:name=>"Indiana",:countries_id=>233)
State.create(:iso=>"ME",:name=>"Maine",:countries_id=>233)
State.create(:iso=>"MI",:name=>"Michigan",:countries_id=>233)
State.create(:iso=>"MN",:name=>"Minnesota",:countries_id=>233)
State.create(:iso=>"NE",:name=>"Nebraska",:countries_id=>233)
State.create(:iso=>"NH",:name=>"New Hampshire",:countries_id=>233)
State.create(:iso=>"NJ",:name=>"New Jersey",:countries_id=>233)
State.create(:iso=>"NY",:name=>"New York",:countries_id=>233)
State.create(:iso=>"OH",:name=>"Ohio",:countries_id=>233)
State.create(:iso=>"RI",:name=>"Rhode Island",:countries_id=>233)
State.create(:iso=>"VT",:name=>"Vermont",:countries_id=>233)
State.create(:iso=>"WI",:name=>"Wisconsin",:countries_id=>233)
State.create(:iso=>"CA",:name=>"California",:countries_id=>233)
State.create(:iso=>"CO",:name=>"Colorado",:countries_id=>233)
State.create(:iso=>"NM",:name=>"New Mexico",:countries_id=>233)
State.create(:iso=>"NV",:name=>"Nevada",:countries_id=>233)
State.create(:iso=>"UT",:name=>"Utah",:countries_id=>233)
State.create(:iso=>"AZ",:name=>"Arizona",:countries_id=>233)
State.create(:iso=>"ID",:name=>"Idaho",:countries_id=>233)
State.create(:iso=>"MT",:name=>"Montana",:countries_id=>233)
State.create(:iso=>"ND",:name=>"North Dakota",:countries_id=>233)
State.create(:iso=>"OR",:name=>"Oregon",:countries_id=>233)
State.create(:iso=>"SD",:name=>"South Dakota",:countries_id=>233)
State.create(:iso=>"WA",:name=>"Washington",:countries_id=>233)
State.create(:iso=>"WY",:name=>"Wyoming",:countries_id=>233)
State.create(:iso=>"HI",:name=>"Hawaii",:countries_id=>233)
State.create(:iso=>"AK",:name=>"Alaska",:countries_id=>233)
State.create(:iso=>"KY",:name=>"Kentucky",:countries_id=>233)
State.create(:iso=>"MA",:name=>"Massachusetts",:countries_id=>233)
State.create(:iso=>"PA",:name=>"Pennsylvania",:countries_id=>233)
State.create(:iso=>"VA",:name=>"Virginia",:countries_id=>233)